    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if reviews.count() > 0: # if there is a collection with searched keyword and it has records in it
                ...
                flipkart_url = "https://www.tatacliq.com/apple-iphone-11-128gb--black/p-mp000000008075545" + searchString # preparing the URL to search the product on flipkart
                uClient = uReq(flipkart_url) # requesting the webpage from the internet
                flipkartPage = uClient.read() # reading the webpage
                uClient.close() # closing the connection to the web server
                flipkart_html = bs(flipkartPage, "html.parser") # parsing the webpage as HTML
                bigboxes = flipkart_html.findAll("div", {"class": "xfCnu1qYxo-6lOVtxyxCo"}) # seacrhing for appropriate tag to redirect to the product link
                del bigboxes[0:1] # the first 3 members of the list do not contain relevant information, hence deleting them.
